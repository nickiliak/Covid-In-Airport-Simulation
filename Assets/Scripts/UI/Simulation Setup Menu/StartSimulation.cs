...
public class StartSimulation : MonoBehaviour
{
    ...
    void InitiateSimulationData()
    {
        ...
        sd.UpdateMaximumNumberOfInfected(int.Parse(VirusNoInfected.text));
        sd.UpdateInfectionRange(int.Parse(VirusInfectRange.text));
        sd.UpdateVirusInfectiousness(int.Parse(VirusInfectiousness.text));

        sd.UpdateMaskWearing(MaskWearing);
    }
